...
#define ITSDK_WITH_UART				( __UART_USART1 )						// Use LPUART1 and USART2 for debug
#define ITSDK_WITH_UART_RXIRQ		__UART_USART1							// Setup some of the UART with IRQ enabled for RX
...
#define ITSDK_LOGGER_CONF			0x0F00									// error->info level on serial1 => USART2 (see logger.c) (File/Serial1/Serial2/Debug)
...
#define ITSDK_LOWPOWER_GPIO_B_KEEP	(  __LP_GPIO_NONE \
									...
									/*	 | __LP_GPIO_12*/ 	/* spi2 NSS */		\
									/*	 | __LP_GPIO_13*/	/* spi2 SCL */		\
									/*	 | __LP_GPIO_14*/	/* spi2 MISO */		\
									/*	 | __LP_GPIO_15*/	/* spi2 MOSI */		\
									)										// Keep activ
...
#define ITSDK_WITH_SIGFOX_LIB		__ENABLE								// Include the sigfox code when 1 disabled when 0
#define ITSDK_SIGFOX_LIB			__SIGFOX_SX1276							// Type of Sigfox module

#define ITSDK_WITH_LORAWAN_LIB		__DISABLE								// Include the lorawan code when 1 disabled when 0
#define ITSDK_LORAWAN_LIB			__LORAWAN_NONE
